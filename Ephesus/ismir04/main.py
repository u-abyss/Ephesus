...
def run_algorithm_with_similarity_and_source_category_num(index_weight_list):
    # ノードの数
...
def run_algorithm_with_similarity(index_weight_list):
    # ノードの数
    NODE_NUM = len(index_weight_list)
...
# run_algorithm_with_similarity()
# run_algorithm_with_similarity_and_source_category_num()
...
for idx in range(results_len):
    ...
    run_algorithm_with_similarity_and_source_category_num(index_weight_list)
